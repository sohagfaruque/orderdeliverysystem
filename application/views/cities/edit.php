...
<div class="right_countainer">
    ...
    <div class="center_box">
        <form method="post" action="<?php echo base_url('cities/edit').'/'.$data->id;?>"name="register_form" id="register_form" enctype="multipart/form-data">
            <div class="edit_box">
                <div class="cont">English Name<font color="red">*</font></div>
                <div class="tab col-lg-6">
                    <input type="text" class="form-control" name="city_name_english" value="<?php echo $data->city_name_english?>">
            ...
            <div class="edit_box">
                ...
                <div class="tab col-lg-6">
                    <input type="text" class="form-control" name="city_name_arabic" value="<?php echo $data->city_name_arabic?>">
