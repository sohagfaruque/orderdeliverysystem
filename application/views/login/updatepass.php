		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="span12 center login-header">
					<h2>Notification App Reset Password</h2>
			...
			<div class="row-fluid">
				<div class="well span5 center login-box">
					<div class="alert alert-info">
						Please Type Password to Change.
					</div>
                                           <?php
				if(isset($err_msg)){?>
				...
				<?php }
				?>
                                    <form class="form-horizontal" action="<?php echo base_url();?>login/updatepassword/<?php echo $this->uri->segment('3')?>" method="post">
						<fieldset>
							<div class="input-prepend" title="Username" data-rel="tooltip">
								<span class="add-on"><i class="icon-envelope"></i></span><input autofocus class="input-large span10" name="pass" id="email" type="password" value="<?php echo set_value('email') ?>" />
								<?php echo form_error('pass', '<p class="error-mas">', '</p>'); ?>
							</div>
							<div class="clearfix"></div>
							<div class="input-prepend" title="Username" data-rel="tooltip">
								<span class="add-on"><i class="icon-envelope"></i></span><input autofocus class="input-large span10" name="passconf" id="email" type="password" value="<?php echo set_value('email') ?>" />
